      ...
      <main className='about-content'>
        ...
        <section className='about-info-section'>
          <p className='about-info-p'>
            ...
            <br />
            <br />
            Tengo un título de <i>Técnico Superior Universitario</i> en <b>Desarrollo de SOftware Multiplataforma</b> y otro en una <i>Ingeniería</i> en <b>Desarrollo y Gestión de Software</b>.
            <br />
            <br />
